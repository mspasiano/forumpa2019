...
@css[tip](Sistema di presentazione delle candidature online per il reclutamento del personale dipendente e degli altri rapporti di lavoro e formazione del Consiglio Nazionale delle Ricerche, il sitema attualmente in uso al CNR è stato richiesto in riuso dall' *Accademia dei Lincei*, *Stazione Zoologica Anton Dohrn*, *Istituto Superiore di Sanità*; inoltre con una customizzazione e in uso al *Dipartimento della Funzione Pubblica* per gestire l'elenco degli Organismi Indipendenti di Valutazione.)
